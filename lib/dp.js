...
(function(global) {
  ...
  class DpCombobox extends DpComponent {
    ...
    _upgradeFromSelect() {
      ...
      this._display.type = 'text';
      this._display.readOnly = true;
      this._display.classList.add('dp-cb-display', 'input', 'input-bordered', 'w-full');
    ...
    _buildEditorModal() {
      ...
      for (const col of cols) {
        ...
        if (type === 'textarea') {
          ...
          cbDisplay.classList.add('dp-cb-display', 'input', 'input-bordered', 'w-full');
      ...
      if (this._editorOpts.onDeleteRow) {
        ...
        delBtn.type = 'button';
        delBtn.className = 'btn btn-error btn-outline';
