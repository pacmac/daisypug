...
$.dui.page.genselect = function(gco,combos){
  ...
  $.dui.page.valid($('form#generator').form('validate'));
...
$( document ).ready(function() {
  ...
  $('#GEN_CLASS_ID').combobox({
    ...
    onSelect:function(rec){
      ...
      $.dui.page.valid(false);
  
      ajaxget('/',{
        _sqlid:'vwltsa^pn_gendata',
        _func: 'get',
        CLASS_ID: rec.value
      },function(res){
        ...
        $.each(combos,function(){$(this).combobox('options').onSelect=function(){$.dui.page.genselect(opt,combos)}}) 
      })    
    }
  })
