...
*/
  ...
  $.page.fn.dbGrid = function (value) {
    ...
    var reqFlds = {
      P: ["PART_ID", "UNIT_PRICE"],
      S: ["LINE_DESCRIPTION", "WOREF", "UNIT_PRICE"],
      J: ["LINE_DESCRIPTION", "WOREF", "UNIT_PRICE"],
      E: ["LINE_DESCRIPTION", "UNIT_PRICE"],
      F: ["LINE_DESCRIPTION", "WOREF", "UNIT_PRICE"],
      I: ["LINE_DESCRIPTION", "WOREF", "UNIT_PRICE"],
      O: [],
    };
    var optFlds = {
      P: ["LINE_DESCRIPTION", "WOREF"],
      S: ["PART_ID"],
      J: ["PART_ID"],
      E: ["PART_ID", "WOREF"],
      F: ["PART_ID"],
    ...
    opt.tbar.form
      .find('input[textboxname="DELIVERY_DATE"]')
      .datebox("required", false);
    opt.tbar.form
      .find('input[textboxname="PART_DESCRIPTION"]')
      .datebox("readonly", true);
  };
  $.page.fn.clearData = function (value) {
    var dg = $("#polines");
    var opt = dg.datagrid("options");
    // var row = dg.datagrid('getSelected')
    //  var idx = dg.datagrid('getRowIndex',row);
  ...
  $.page.fn.opts = {
    ...
    columns: [
      [
          ...
          editor: {
            ...
            options: {
              ...
              data: [
                ...
                { text: "FREIGHT", value: "F" },
                { text: "INSPECTION & CERTIFICATION", value: "I" },
                { text: "JOB RELATED", value: "J" },
                { text: "OTHERS", value: "O" },
                { text: "PART ORDER", value: "P" },
                { text: "SUBCONTRACT", value: "S" },
              ],
              onSelect: function (nv) {
                $.page.fn.clearData(nv.value);
                $.page.fn.dbGrid(nv.value);
                var woref = $("#_dgform > form input[textboxname=WOREF");
                if (nv.value == "S")
                  woref.searchbox("options").queryParams.SUBCON = "Y";
                if (nv.value == "J")
                  woref.searchbox("options").queryParams.SUBCON = "N";
                woref.searchbox("options").dlog.dg.datagrid("reload");
              },
            },
          },
          coloff: true,
          ...
          editor: {
            ...
            options: {
              ...
              onSelect: function (rw) {
                ...
                ajaxget(
                  "/",
                  { _sqlid: "inv^partall", _func: "get", ID: rw.value },
                  function (part) {
                    opt.tbar.form
                      .find('input[textboxname="LINE_DESCRIPTION"]')
                      .textbox("setValue", part.DESCRIPTION);
                    opt.tbar.form
                      .find('input[textboxname="PURCHASE_UOM"]')
                      .textbox("setValue", part.UOM_ID);
                  },
                );
              },
            },
        ...
        },
        {
          ...
          editor: {
            ...
            options: {
              ...
              fields: [
                {
                  field: "WORKORDER_BASE_ID",
                  title: "Job ID",
                  editor: "textbox",
                },
                {
                  field: "WORKORDER_LOT_ID",
                  title: "Lot ID",
                  editor: "textbox",
                },
                {
                  field: "WORKORDER_SUB_ID",
                  title: "Sub ID",
                  editor: "textbox",
                },
        ...
        },
        {
          ...
          editor: {
            type: "textbox",
            options: { readonly: false, multiline: true, height: 100 },
          },
          coloff: true,
        },
      ],
    ...
    onLoadSuccess: function () {
      $("tr td .icon-ship.icon-dg").off().on("click", $.page.fn.receiptinfo);
    ...
    onEndEdit: function (idx, row, chg) {
      console.log(`L296 - Row:`, row, `Changes:`, chg);
      ...
      // var data = clone(row);
      var data = row;
      var dels = ["PART_DESCRIPTION", "TRACEABLE", "CURRENCY_RATE"];
      dels.map(function (e) {
        delete data[e];
      });
      ...
      // console.log(data);
      var POID = data.PO_ID;
      ajaxget(url, data, function (data1) {
  ...
  $(document).ready(function () {
    ...
    $("#VENDOR_ID").searchbox({
      ...
      onSelect: function (row) {
        ...
        ajaxget(
          "/",
          { _sqlid: "inv^vendorall", _func: "get", ID: rec },
          function (data) {
            ...
            $("#PAYMENT_TERM").combobox("reselect");
    ...
    toolbut([
      {
        ...
        noText: false,
        onClick: () => {
          printmen({ id: "inv^purchase_manager^purchase_form" });
        },
      },
      {},
    ]);
    ...
    $("form#pohead")
      .on("loadDone", function (jq, data) {
        ...
        if (data.CURRENCY_RATE == "" && !data.CURRENCY_RATE)
